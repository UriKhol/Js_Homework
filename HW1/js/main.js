...
function createCharacter(сharactersLength, numOfLattices) {
    var leftLatticesPoint = (сharactersLength - numOfLattices) / 2;
    var massive = [];

    for(var i = 0; i < сharactersLength; i++) {
        massive.push("-")
    }
    for(var i = 0; i < numOfLattices; i++) {
...
function pyramid(medianNumber) {
    var сharacters = medianNumber * 2 - 1,
        Lattices = 1;
    for(var i = 0; i < medianNumber; i++) {
